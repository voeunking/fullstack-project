    ...
    <div class="min-h-screen flex">
        <aside class="w-64 bg-slate-900 text-white flex flex-col">
            ...
            <nav class="flex-1 p-4 space-y-2">
                <a href="{{ route('admin.dashboard') }}" class="flex items-center px-4 py-2 rounded {{ request()->routeIs('admin.dashboard') ? 'bg-slate-700' : 'hover:bg-slate-800' }}">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path></svg>
                    Dashboard
                </a>
                <a href="{{ route('admin.products.index') }}" class="flex items-center px-4 py-2 rounded {{ request()->routeIs('admin.products.*') ? 'bg-slate-700' : 'hover:bg-slate-800' }}">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"></path></svg>
                    Products
                </a>
                <a href="{{ route('admin.categories.index') }}" class="flex items-center px-4 py-2 rounded {{ request()->routeIs('admin.categories.*') ? 'bg-slate-700' : 'hover:bg-slate-800' }}">
                ...
                <a href="{{ route('admin.users.index') }}" class="flex items-center px-4 py-2 rounded {{ request()->routeIs('admin.users.*') ? 'bg-slate-700' : 'hover:bg-slate-800' }}">
            ...
            <div class="p-4 border-t border-slate-700">
                <a href="/" class="flex items-center px-4 py-2 rounded hover:bg-slate-800 text-sm">
